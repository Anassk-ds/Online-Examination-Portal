  ...
  return (
    <div style={styles.viewWindow} className="page-fade-in">
      ...
      {/* CRITICAL ISOLATION LAYER: 
        Instead of relying on parent flex tracks that global CSS easily breaks,
        we dynamically toggle display visibility (block vs none) based on active state.
        This provides a 100% bug-free interface where only one active portal can ever render at a time.
      */}

      {/* PANEL 1: STUDENT PORTAL VIEWPORT */}
      <div style={{ ...styles.panelPageLight, display: activePanel === 0 ? 'flex' : 'none' }}>
      ...
      {/* PANEL 2: ADMIN CONSOLE VIEWPORT */}
      <div style={{ ...styles.panelPageDark, display: activePanel === 1 ? 'flex' : 'none' }}>
